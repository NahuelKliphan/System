  ...
  aceptar() {
    ...
    if (this.formCompleto()) {
      ...
      if (this.porcentaje) {
        ...
        if (this.redondeo) {
          consulta += `${this.registroPrecio.unRegistroPrecio.tipo_precio} = case when mod((${this.registroPrecio.unRegistroPrecio.tipo_precio} ${this.registroPrecio.unRegistroPrecio.operacion} ${this.registroPrecio.unRegistroPrecio.tipo_precio} *${this.registroPrecio.unRegistroPrecio.valor}),100) = 0 then (${this.registroPrecio.unRegistroPrecio.tipo_precio} ${this.registroPrecio.unRegistroPrecio.operacion} ${this.registroPrecio.unRegistroPrecio.tipo_precio} *${this.registroPrecio.unRegistroPrecio.valor}) else case when mod((${this.registroPrecio.unRegistroPrecio.tipo_precio} ${this.registroPrecio.unRegistroPrecio.operacion} ${this.registroPrecio.unRegistroPrecio.tipo_precio} *${this.registroPrecio.unRegistroPrecio.valor}),100) <= 5 then (${this.registroPrecio.unRegistroPrecio.tipo_precio} ${this.registroPrecio.unRegistroPrecio.operacion} ${this.registroPrecio.unRegistroPrecio.tipo_precio} *${this.registroPrecio.unRegistroPrecio.valor}) - mod((${this.registroPrecio.unRegistroPrecio.tipo_precio} ${this.registroPrecio.unRegistroPrecio.operacion} ${this.registroPrecio.unRegistroPrecio.tipo_precio} *${this.registroPrecio.unRegistroPrecio.valor}),100) else (${this.registroPrecio.unRegistroPrecio.tipo_precio} ${this.registroPrecio.unRegistroPrecio.operacion} ${this.registroPrecio.unRegistroPrecio.tipo_precio} *${this.registroPrecio.unRegistroPrecio.valor}) + (100 - mod((${this.registroPrecio.unRegistroPrecio.tipo_precio} ${this.registroPrecio.unRegistroPrecio.operacion} ${this.registroPrecio.unRegistroPrecio.tipo_precio} *${this.registroPrecio.unRegistroPrecio.valor}),100)) end end `;
        } else {
        ...
        if (this.redondeo) {
          consulta += `${this.registroPrecio.unRegistroPrecio.tipo_precio} = case when mod(${this.registroPrecio.unRegistroPrecio.valor} + ${this.registroPrecio.unRegistroPrecio.tipo_precio},100) = 0 then ${this.registroPrecio.unRegistroPrecio.valor} + ${this.registroPrecio.unRegistroPrecio.tipo_precio} else case when mod(${this.registroPrecio.unRegistroPrecio.valor} + ${this.registroPrecio.unRegistroPrecio.tipo_precio},100) <= 5 then ${this.registroPrecio.unRegistroPrecio.valor} + ${this.registroPrecio.unRegistroPrecio.tipo_precio} - mod(${this.registroPrecio.unRegistroPrecio.valor} + ${this.registroPrecio.unRegistroPrecio.tipo_precio},100) else ${this.registroPrecio.unRegistroPrecio.valor} + ${this.registroPrecio.unRegistroPrecio.tipo_precio} ${this.registroPrecio.unRegistroPrecio.operacion} (100 - mod(${this.registroPrecio.unRegistroPrecio.valor} + ${this.registroPrecio.unRegistroPrecio.tipo_precio},100)) end end `;
        } else {
